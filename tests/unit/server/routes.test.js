...
describe('#Routes - test site for api response', () => {
    ...
    test(`GET /home - should response with ${pages.homeHTML} file stream no content-type`, async () => {
        const params = TestUtil.defaultHandleParams()
        params.request.method = 'GET'
        params.request.url = '/home'
    ...
    test(`GET /controller - should response with ${pages.controllerHtml} file stream no content-type`, async () => {
        const params = TestUtil.defaultHandleParams()
        params.request.method = 'GET'
        params.request.url = '/controller'
        const mockFileStream = TestUtil.generateReadableStream(['data'])
    ...
    describe('exceptions', () => {
        ...
        test('given error file it should repond with 500', async () => {
            const params = TestUtil.defaultHandleParams()
            params.request.method = 'GET'
            params.request.url = '/index.png'
            jest.spyOn(
